...
The results reveal an interesting trade-off landscape. NF4 achieves the Pareto optimal point with the highest accuracy at the lowest memory footprint, as shown in Figure~\ref{fig:accuracy_memory}. The 4-bit quantization reduces memory usage by 59\% (1392 MB savings) compared to the FP16 baseline, as visualized in Figure~\ref{fig:memory_waterfall}.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\columnwidth]{fig1_accuracy_vs_memory.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\columnwidth]{fig5_memory_waterfall.pdf}
