...
Figure~\ref{fig:summary} summarizes the key results of this study.
...
\vspace{0.5em}
\noindent\textbf{Code Availability.} The complete source code and experimental configurations are available at: \url{https://github.com/Orko24/McGill_Interview_Warren_Gross/tree/main/llama_rewrite_3}
