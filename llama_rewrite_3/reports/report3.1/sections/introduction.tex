...
FP8 could not be tested because BitsAndBytes 8-bit quantization (LLM.int8()~\cite{dettmers2022llmint8}) encounters a CUDA kernel bug on both A10G and A100 GPUs, which remains an unresolved upstream issue in the bitsandbytes library.
