...
\textbf{BitsAndBytes 8-bit Bug.} 8-bit quantization (LLM.int8()~\cite{dettmers2022llmint8}) encounters a CUDA kernel bug (\texttt{invalid configuration argument at line 380 in ops.cu}) on A10G and A100 GPUs---an unresolved upstream issue.
